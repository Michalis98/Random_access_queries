...
class HashBucket {
	...
	public void insertKey(int key, LinearHashing2 linearHashing) { // inserts a key to the node
	...
	int removeLastKey(LinearHashing2 lh) {	// remove bucket last key
	...
	public int searchKey2(int key, LinearHashing2 lh) {
		level2=0;
		return searchKey(key,lh);
		
	}
	
	public int searchKey(int key, LinearHashing2 lh) {
	...
	public void splitBucket(LinearHashing2 linearHashing, int n, int bucketPos, HashBucket newBucket) {	//splits the current bucket
	...
	public void mergeBucket(LinearHashing2 lh, HashBucket oldBucket) {	//merges the current bucket
