...
class LinearHashing2 {
	...
	public LinearHashing2(int itsBucketSize, int initPages) { 	// Constructor.
	...
	public void insertKey(int key) {	// Insert a new key.
		...
		if ((this.loadFactor() > maxThreshold)||(this.divided>2)){
	...
	public int searchKey(int key) {		// Search for a key.
		...
		return this.hashBuckets[this.hashFunction(key)].searchKey2(key, this);
	}
